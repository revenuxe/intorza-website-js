...
const testimonials = [
  {
    ...
    content: "Intorza has completely transformed how I manage my projects. The quotation builder alone has saved me hours every week. Highly recommended!",
    rating: 5,
  },
  {
    name: "Priya Sharma",
      ...
      <div className="container-custom">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-secondary-foreground/70">
            See what our users have to say about how Intorza has helped 
